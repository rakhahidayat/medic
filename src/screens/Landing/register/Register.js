                ...
                <View style={{flexDirection:'row', flex: 0}}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <View style={{backgroundColor: '#fff', padding: Utils.wp(15)}}>
                            <Text style={styles.logoTextLogin}>DAFTAR AKUN BARU</Text>
                            ...
                            {/* <TextField
                                ...
                                <TextField
                                    ...
                                    error={this.state.contactError == true && this.state.contactNumber != '' ? 'Please enter a valid phone number' : ''}
                                    onChangeText={(this._onContactChange.bind(this))}
                                /> */}
                                <PasswordInputText
                                    baseColor='#bfbfbf'
                                    fontSize={Utils.fixedFontSize(14)}
                                ...
                                <View style={{flexDirection: "row"}}>
                                    ...
                                    />
                                    <Text style={{margin:8}}>Saya menyetujui Syarat & Ketentuan yang berlaku</Text>
                                </View>
                                <TouchableOpacity
                                    activeOpacity={0.9}
                                    style={styles.buttonRegister}
                                    onPress={() => { this.handleRegisterButton() }}>
                                    <Text style={[styles.textButton]}>Daftar Sekarang</Text>
                                </TouchableOpacity>
                        </View>

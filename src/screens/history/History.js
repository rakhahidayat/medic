    ...
    render() {
        return (
            <View style={styles.containerMain}>
                ...
                <Text>Tekan untuk info lebih detail</Text>
                <View style={styles.flatlistBox}>
                    <ScrollView
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity activeOpacity={0.9} onPress={() => this.detailHistory()}>
                                    <View style={{ alignItems: 'center', paddingBottom: Utils.wp(20), marginTop: Utils.wp(20), flexDirection: 'row' }}>
                                        <Image style={{  width: Utils.wp(40), height: Utils.wp(40), marginRight: Utils.wp(20), justifyContent: 'flex-end'}} source = {require('../../assets/icons/history.png')} />
